  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Jost:ital,wght@0,300..900;1,400&family=Playfair+Display:ital,wght@0,400..900;1,400..900&display=swap" rel="stylesheet" />
      </Head>
      <body>
        <Main />
        <NextScript />
